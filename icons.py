...
def getGetHandBitmap():
    return wx.BitmapFromXPMData(getGetHandData())

def getGetHandImage():
    return wx.ImageFromBitmap(getGetHandBitmap())
...
def getGetPlusBitmap():
    return wx.BitmapFromXPMData(getGetPlusData())

def getGetPlusImage():
    return wx.ImageFromBitmap(getGetPlusBitmap())
...
def getGetMinusBitmap():
    return wx.BitmapFromXPMData(getGetMinusData())

def getGetMinusImage():
    return wx.ImageFromBitmap(getGetMinusBitmap())
